...
class DatabaseManager:
    ...
    def __init__(self, logger, root = "/darma_online/darma_online/src/darma_online/data"):
        self.logger = logger
        self.root_dir = root
    ...
    def search_moderated(self, obj_id: str) -> bool:
        ...
        self.logger.info(f"Post Id {obj_id} is {'present' if is_moderated else 'not present'} in the moderated database")
