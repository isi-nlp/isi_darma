...
def evaluate_conversation(
    ...
    endpoint_query_func = endpoints_dict[default_endpoint]
...
def parse_args():     
    ...
    # TODO; remove; as it is useless/redundant unless wanna override the engine (confusing but kept for backward compatability)
...
def main(): 
    ...
    for bot_persona in bot_ids:
        for user_persona in user_personas: 
            ...
            fp = f"self-talk_engine={args['default_endpoint']}|{bot_persona=}|{user_persona=}.json"
